  ...
  <diagram name="Architecture Diagram" id="diagram1">
    ...
    const autoLayout = useCallback(() => {
        ...
        const layoutContainer = (container, baseZ = 1) => {
            ...
            // ensure size fits label/description
            ...
            let neededHeight = textSize.height;
            ...
            if (children.length > 0) {
                ...
                children.forEach((child, i) => {
                    ...
                    child.position = {
                        ...
                        y: padding / 2 + row * (maxChildH + padding),
                    };
                ...
                neededHeight = Math.max(neededHeight, padding + rows * (maxChildH + padding));
            }
